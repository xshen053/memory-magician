...
export async function drawGraph(baseUrl, isHome, pathColors, graphConfig) {
  let {
    depth,
    enableDrag,
    enableLegend,
...
async function fetchData() {
  // Mock fetching data, replace with your actual data fetching logic
  return {
    index: {
      links: {
        "/": [{ target: "/page1" }, { target: "/page2" }],
        "/page1": [{ target: "/" }, { target: "/page2" }],
        "/page2": [{ target: "/" }],
      },
      backlinks: {
        "/": [{ source: "/page1" }, { source: "/page2" }],
        "/page1": [{ source: "/" }],
        "/page2": [{ source: "/" }, { source: "/page1" }],
      },
    },
    links: [
      { source: "/", target: "/page1" },
